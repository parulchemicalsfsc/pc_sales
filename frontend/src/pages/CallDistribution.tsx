    ...
    <Box>
      ...
      {loading ? (
        ...
        <>
          ...
          {/* ── Telecaller Distribution Status Cards ── */}
          {tcSummary.length > 0 && (
            <Box sx={{ mb: 4 }}>
              <Typography variant="subtitle2" sx={{ fontWeight: 700, color: "text.secondary", mb: 1.5, textTransform: "uppercase", letterSpacing: 0.5, fontSize: "0.7rem" }}>
                Telecaller Distribution Status
              </Typography>
              <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} sm={6} md={4} key={email}>
                      <Card
                        ...
                        sx={{
                          ...
                          cursor: "pointer",
                          transition: "all 0.2s",
                          "&:hover": { boxShadow: theme.shadows[4], transform: "translateY(-2px)", borderColor: theme.palette.success.main },
                        }}
                      >
                        <CardContent sx={{ p: 2.5, "&:last-child": { pb: 2.5 } }}>
                          <Stack direction="row" alignItems="center" spacing={1.5} sx={{ mb: 1.5 }}>
                            <Avatar sx={{ width: 36, height: 36, bgcolor: alpha(theme.palette.success.main, 0.1), color: "success.main", fontSize: 14, fontWeight: 700 }}>
                              {d.name.charAt(0).toUpperCase()}
                            </Avatar>
                            <Box sx={{ flex: 1, minWidth: 0 }}>
                              <Typography variant="subtitle2" sx={{ fontWeight: 700, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
